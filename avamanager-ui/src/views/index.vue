...
<!--          >-->
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>Ava管理系统</h2>
        <p>
          一直想做一款后台管理系统，看了很多优秀的开源项目，本系统主要基于springboot、ruoyi、vue等框架编写，详细使用的技术框架下面有列出，本项目遵守开源协议
        </p>
        <p>
        ...
        <p>
          ...
          <el-button
            ...
            icon="el-icon-s-home"
            plain
            @click="goTarget('https://github.com/ATYXXA/AvaManager')"
            >本项目github地址</el-button
          >
        </p>
      </el-col>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 本人掘金主页：<el-link
                href="https://juejin.cn/user/1165910699421502"
                target="_blank"
                >KiraFenvy的掘金主页</el-link
              >
            </p>
